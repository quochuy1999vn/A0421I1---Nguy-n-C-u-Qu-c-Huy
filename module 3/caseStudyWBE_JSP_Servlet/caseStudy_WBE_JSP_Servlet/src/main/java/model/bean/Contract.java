...
public class Contract {
    ...
    public Contract(int contract_id, String contract_start_date, String contract_end_date, double contract_deposit, double contract_total_money, Employee employee_id, Customer customer_id, Service service_id) {
