...
<head>
    ...
    <link rel="stylesheet" href="listCustomerCSS.css">
</head>
<body>
...
<%--                <a href="#">Contract</a>--%>
<%--            </div>--%>
<%--            <div class="col-lg-3"><form action="/users" method="get" style="align-items: center">--%>
            ...
            <table border="1" cellpadding="5">
                ...
                <c:forEach var="customer" items="${customerList}">
                    <tr>
                        ...
                        <td>
                            <a href="/users?action=edit&id=${customer_id}">Edit</a>
                            <a href="/users?action=delete&id=${customer_id}">Delete</a>
                        </td>
                    </tr>
                </c:forEach>
            </table>
